...
public class HeadEntity extends BaseEntity<HeadEntity>  {
	 ...
	 */
	@TableField("IN_RATIO")
	@ByteLength(max = 8, message = "inRatio长度超过限制！")
	...
	@ByteLength(max = 18, message = "apprImgAmt长度超过限制！")
	...
	@ByteLength(max = 18, message = "apprExgAmt长度超过限制！")
	...
	@NotEmpty(message="expiryDate不能为空！")
	@DateTimeFormat(pattern = "yyyy-MM-dd") 
	...
	@NotEmpty(message="insertTime不能为空！")
	@DateTimeFormat(pattern = "yyyy-MM-dd") 
	...
	@NotEmpty(message="insertUser不能为空！")
	...
	public BigDecimal getUseHbCount() {
		return useHbCount;
	}

	public void setUseHbCount(BigDecimal useHbCount) {
	...
	public boolean equals(Object obj) {
		...
		if(((HeadEntity)obj).oid== this.oid)
			return true;
		return false;
	}
}
